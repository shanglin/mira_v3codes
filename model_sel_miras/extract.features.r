...
outdir = '~/Work/m33_miras/model_sel_miras/'
...
if (type == 'mira') {
    ...
    f.jkl = paste0('~/Work/m33_miras/simulate_mira/mira.stet.jkl.vals/simu_mira_m0',field,'.jkl')
    dir.lc = '~/Work/m33_miras/simulate_mira/v3_mira_flcs/'
    star.class = 1
}
if (type == 'srv') {
    pattern = paste0('^',type,'......',field,'.*.gp.dat$')
    f.jkl = paste0('~/Work/m33_miras/simulate_srv/srv.stet.jkl.vals/simu_srv_m0',field,'.jkl')
    dir.lc = '~/Work/m33_miras/simulate_srv/v3_srv_flcs/'
    star.class = 0
}
if (type == 'const') {
    # blabla
...
spcdir = paste0(dir,type,'_gp_result/')
...
if (file.exists(f.jkl)) {
    ...
    print(paste0('  FILE ',f.jkl,' NOT FOUND!'))
    stop('')
}

f.out = paste0(outdir,type,'_m0',field,'_features.dat')
