...
if (type == 'mira') {
    ...
    system(cmd)
    spcdir = '/fdata/scratch/yuanwenlong/m33_v3/super_compute_all/mira/gp_result_v2/'
    pattern = paste0('^',type,'.......',field,'.*.gp.dat$')
    f.jkl = paste0('/fdata/scratch/yuanwenlong/Shared/mira.stet.jkl.vals/simu_mira_m0',field,'.jkl')
    dir.lc = '/fdata/scratch/yuanwenlong/Shared/v3_mira_flcs/'
    star.class = 1
}
if (type == 'srv') {
    outdir = paste0('./feature_',type)
...
if (nfs.dat < 1) {
    print('  NOT LIGHT CURVES AND SPECTRA IN THIS FIELD! SKIPPED!')
    stop('')
}
