...
## output file header 
header = '"ID","Field","StarID","RA","Decl","Type","Evol","Spectr","I","V","P_1","A_1","P_2","A_2","P_3","A_3","ID_OGLE_II","ID_MACHO","ID_GCVS","ID_OTHER","Remarks","Prob"'
...
f.out = paste0(dir,'tableA/conv_lmc_mira_s1.csv')
mk.table(fit1,lmc1,f.out)

f.out = paste0(dir,'tableA/conv_lmc_mira_s2.csv')
mk.table(fit2,lmc2,f.out)

f.out = paste0(dir,'tableA/conv_lmc_mira_si.csv')
